...
export class AppComponent {
  ...
  bio2: "Carlos started programming his Commodore 64 back in the 80s and has been doing it ever since.  He opened a \"Friendly Neighbourhood Computer Shop\" in Etobicoke in 1998 and proudly provided amazing service there for 15 years. In 2013 he moved to Burlington and started Geek2go.ca to provide top-notch IT services for individuals and businesses in the area.  When he's not working, you can find him spending time with his family, playing video games, or exploring the latest tech trends.",
  bio3: "Carlos is a Funky DJ by night who also loves geek culture, Tech, Art & puts them all together at (Drum Roll Please) FunkyRobot.ca",
